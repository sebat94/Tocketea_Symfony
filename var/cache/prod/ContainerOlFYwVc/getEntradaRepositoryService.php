...
// Returns the private 'App\Repository\EntradaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\EntradaRepository.php';

return $this->privates['App\Repository\EntradaRepository'] = new \App\Repository\EntradaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
