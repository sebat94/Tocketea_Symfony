...
class Usuario extends \App\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'username', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'imagen', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'fk_provincia', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'rol', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'idioma', '' . "\0" . 'App\\Entity\\Usuario' . "\0" . 'isActive'];
        }
