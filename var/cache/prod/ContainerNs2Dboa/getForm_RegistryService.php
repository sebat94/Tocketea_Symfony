...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\EventoType' => function () {
    return ($this->privates['App\Form\EventoType'] ?? $this->load(__DIR__.'/getEventoTypeService.php'));
}, 'App\\Form\\PerfilType' => function () {
    return ($this->privates['App\Form\PerfilType'] ?? $this->load(__DIR__.'/getPerfilTypeService.php'));
}, 'App\\Form\\UsuarioType' => function () {
    return ($this->privates['App\Form\UsuarioType'] ?? $this->load(__DIR__.'/getUsuarioTypeService.php'));
