...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\EntradaController' => __DIR__.'/getEntradaControllerService.php',
            'App\\Controller\\EventoController' => __DIR__.'/getEventoControllerService.php',
            'App\\Controller\\PagesController' => __DIR__.'/getPagesControllerService.php',
            'App\\Controller\\REST\\AuthRestController' => __DIR__.'/getAuthRestControllerService.php',
            'App\\Controller\\REST\\BaseApiController' => __DIR__.'/getBaseApiControllerService.php',
            'App\\Controller\\REST\\EventRestController' => __DIR__.'/getEventRestControllerService.php',
            'App\\Controller\\REST\\UserRestController' => __DIR__.'/getUserRestControllerService.php',
            'App\\Controller\\SecurityController' => __DIR__.'/getSecurityControllerService.php',
            'App\\Controller\\UsuarioController' => __DIR__.'/getUsuarioControllerService.php',
        ...
        include_once $this->targetDirs[3].'\\src\\GlobalVariablesTwig\\GlobalVars.php';
        ...
        include_once $this->targetDirs[3].'\\src\\EventListener\\ImagenUploadListener.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WUf6b7ur8c', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wJ5nL6VZr0', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), new \App\EventListener\ImagenUploadListener(new \App\Service\FileUploader(($this->targetDirs[3].'/public/img/perfil'))));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setNamespace('sf_orm_default_d2076ad210d6dc52b7e4b27a23e6d3e5f5adbd2ae32c50171a94e9cdbc9d6e57');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf_orm_default_d2076ad210d6dc52b7e4b27a23e6d3e5f5adbd2ae32c50171a94e9cdbc9d6e57');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf_orm_default_d2076ad210d6dc52b7e4b27a23e6d3e5f5adbd2ae32c50171a94e9cdbc9d6e57');
        ...
        $e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategoriaRepository' => function () {
            return ($this->privates['App\Repository\CategoriaRepository'] ?? $this->load(__DIR__.'/getCategoriaRepositoryService.php'));
        }, 'App\\Repository\\EntradaRepository' => function () {
            return ($this->privates['App\Repository\EntradaRepository'] ?? $this->load(__DIR__.'/getEntradaRepositoryService.php'));
        }, 'App\\Repository\\EventoRepository' => function () {
            return ($this->privates['App\Repository\EventoRepository'] ?? $this->load(__DIR__.'/getEventoRepositoryService.php'));
        }, 'App\\Repository\\ProvinciaRepository' => function () {
            return ($this->privates['App\Repository\ProvinciaRepository'] ?? $this->load(__DIR__.'/getProvinciaRepositoryService.php'));
        }, 'App\\Repository\\UsuarioRepository' => function () {
            return ($this->privates['App\Repository\UsuarioRepository'] ?? $this->load(__DIR__.'/getUsuarioRepositoryService.php'));
        }))));

        $this->services['doctrine.orm.default_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create(($this->services['doctrine.dbal.default_connection'] ?? $this->getDoctrine_Dbal_DefaultConnectionService()), $e);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('globalParams', new \App\GlobalVariablesTwig\GlobalVars(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService())));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HFEeJEPw-o', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2D8Yz-U2Ih', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1uh23m1tyX', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.dao.login'] ?? $this->load(__DIR__.'/getSecurity_Authentication_Provider_Dao_LoginService.php'));
            ...
            yield 3 => ($this->privates['security.authentication.provider.guard.api'] ?? $this->load(__DIR__.'/getSecurity_Authentication_Provider_Guard_ApiService.php'));
            yield 4 => ($this->privates['security.authentication.provider.dao.main'] ?? $this->load(__DIR__.'/getSecurity_Authentication_Provider_Dao_MainService.php'));
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.api' => function () {
            return ($this->privates['security.firewall.map.context.api'] ?? $this->load(__DIR__.'/getSecurity_Firewall_Map_Context_ApiService.php'));
            ...
            return ($this->privates['security.firewall.map.context.login'] ?? $this->load(__DIR__.'/getSecurity_Firewall_Map_Context_LoginService.php'));
            ...
            return ($this->privates['security.firewall.map.context.register'] ?? $this->load(__DIR__.'/getSecurity_Firewall_Map_Context_RegisterService.php'));
            ...
            yield 'security.firewall.map.context.login' => ($this->privates['security.request_matcher.CoBPJCB'] ?? $this->privates['security.request_matcher.CoBPJCB'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/v1/auth/login'));
            yield 'security.firewall.map.context.register' => ($this->privates['security.request_matcher.uW0PpAO'] ?? $this->privates['security.request_matcher.uW0PpAO'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/v1/auth/register'));
    ...
    private $loadedDynamicParameters = array(
        ...
        'directorio_usuarios' => false,
        'directorio_eventos' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'directorio_usuarios': $value = ($this->targetDirs[3].'/public/img/perfil'); break;
            case 'directorio_eventos': $value = ($this->targetDirs[3].'/public/img/evento'); break;
